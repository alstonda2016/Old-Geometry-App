...
public class pentagon extends AppCompatActivity {
    ...
    public void findArea(View v) {
       ...
       // TextView cirA = (TextView) findViewById(R.id.textView2);
        ImageView cirA = (ImageView) findViewById(R.id.imageView9);
  ...
  //      TextView cirAA = (TextView) findViewById(R.id.textView6);
    ...
    public void backCircle(View v){
       ...
       // TextView cirP = (TextView) findViewById(R.id.textView2);
        ImageView cirP = (ImageView) findViewById(R.id.imageView9);
        TextView cirName = (TextView) findViewById(R.id.textView3);
...
//        cirAA.setVisibility(View.INVISIBLE);
  //      cirAR.setVisibility(View.INVISIBLE);
    ...
    public void pentaArea(View v) {
        ...
        if(radius.isFocusable() == true) {
            if (radius.getText().length() == 0 && area.getText().length() == 0) {
                ...
                double rad = Math.sqrt((4 * decm) / ((Math.sqrt(5 * (5 + (2 * Math.sqrt(5)))))));
                ...
                double decm = (decFg * decFg) * (.25) * (Math.sqrt(5 * (5 + (2 * Math.sqrt(5)))));
    ...
    public void pentaPerimeter(View v) {
