...
public class hexagon extends AppCompatActivity {
    ...
    public void findArea(View v) {
        ...
        ImageView cirA = (ImageView) findViewById(R.id.imageView8);
...
//button11
    ...
    public void backCircle(View v){
        ...
        ImageView cirP = (ImageView) findViewById(R.id.imageView8);
        TextView cirName = (TextView) findViewById(R.id.textView3);
...
//        cirAA.setVisibility(View.INVISIBLE);
  //      cirAR.setVisibility(View.INVISIBLE);
    ...
    public void hexaArea(View v) {
        ...
        if(radius.isFocusable() == true) {
            if (radius.getText().length() == 0 && area.getText().length() == 0) {
                ...
                double rad = Math.sqrt(decm *   ( 2/ (3 * Math.sqrt(3)) )   );
                ...
                double decm = (decFg * decFg) * ((Math.sqrt(3) * 3) / 2);
    ...
    public void hexaPerimeter(View v) {
