...
public class square2d extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_square2d);
    ...
    public void square2dfacts(View v) {
    ...
    public void circleArea(View v) {
        ...
        if(radius.isFocusable() == true) {
            ...
            if (radius.getText().length() == 0 && area.getText().length() == 0) {
                ...
                double rad = Math.sqrt(decm / Math.PI);
                ...
                double decm = decFg * decFg * Math.PI;
    ...
    public void circlePerimeter(View v) {
        ...
        if(radius.isFocusable() == true) {
            ...
            if (radius.getText().length() == 0 && Perimeter.getText().length() == 0) {
                ...
                double decm = 2 * Math.PI * decFg;
                String strm = String.valueOf(decm);
                Perimeter.setText("C=" + strm);
