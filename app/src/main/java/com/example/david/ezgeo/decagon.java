...
public class decagon extends AppCompatActivity {
    ...
    public void findArea(View v) {
       ...
       // TextView cirA = (TextView) findViewById(R.id.textView2);
        ImageView cirA = (ImageView) findViewById(R.id.imageView7);
...
//button11
  ...
  //      cirPP.setVisibility(View.VISIBLE);
    ...
    public void backCircle(View v){
        ...
        ImageView cirP = (ImageView) findViewById(R.id.imageView7);
        TextView cirName = (TextView) findViewById(R.id.textView3);
...
//        cirPR.setVisibility(View.INVISIBLE);
    ...
    public void decaArea(View v) {
        ...
        if(radius.isFocusable() == true) {
            if (radius.getText().length() == 0 && area.getText().length() == 0) {
                ...
                float A = Float.parseFloat(area.getText().toString());

                double rad = Math.sqrt((2 * A) / (5 * Math.sqrt(5 + (2 * Math.sqrt(5)))));
                ...
                double decm = decFg * decFg * (2.5) * Math.sqrt(5 + (2 * Math.sqrt(5)));
    ...
    public void decaPerimeter(View v) {
